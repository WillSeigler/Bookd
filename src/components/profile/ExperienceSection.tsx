...
import { EmptyProfileSection } from './ProfilePlaceholder';
import { 
        ...
        <div className="p-6">
          {experiences.length === 0 ? (
            <EmptyProfileSection
              ...
              description={isOwner 
                ? "Share your professional experience, education, and notable positions to showcase your musical journey."
                : "This user hasn't added any experience entries yet."
              }
              actionLabel={isOwner ? "Add Experience" : undefined}
              onAction={isOwner ? handleAddNew : undefined}
            />
          ) : (
            <div className="space-y-4">
